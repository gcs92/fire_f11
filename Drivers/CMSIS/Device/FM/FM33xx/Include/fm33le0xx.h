 ...
 *           from CMSIS SVD File 'FM33LE0XX.SVD' Version 1.0,
 *
...
/** @addtogroup FM33LE0XX
  * @{
  */

#ifndef __FM33LE0XX_H
#define __FM33LE0XX_H
...
/**
 * @brief FM33LE0XX Interrupt Number Definition, according to the selected device 
...
/******  FM33LE0XX specific Interrupt Numbers ******************************************************************/
  ...
  I2CSMB_IRQn                   = 18,      /*!<  18   I2CSMB Interrupt                                            */
...
#include "system_fm33le0xx.h"                        /*!< FM33LE0XX System                                     */
#include <stdint.h>
...
typedef struct
{
  ...
  __IO uint32_t CALR;             /*!< ADC Calibration Register,                            Address offset: 0x0C */
  __IO uint32_t CFGR;             /*!< ADC Config Register,                                 Address offset: 0x10 */
  __IO uint32_t SMTR;             /*!< ADC Sampling Time Register,                          Address offset: 0x14 */
  __IO uint32_t CHER;             /*!< ADC Channel Enable Register,                         Address offset: 0x18 */
  __IO uint32_t DR;               /*!< ADC Data Register,                                   Address offset: 0x1C */
...
typedef struct
{
  ...
  __I  uint32_t LINBSR;                 /*!<  UARTx LIN Baud Sync Register,                         Address offset: 0x28 */
}UART_Type;


typedef struct
{
  __IO uint32_t PTATCR;               /*!< PTAT Control Register             */
  __IO uint32_t RSV0;                 /*!< RESERVED REGISTER              */
  __IO uint32_t RSV1;                 /*!< RESERVED REGISTER    */
  __IO uint32_t BUFCR;                /*!< VREF BUFFER Control Register    */
} VREF_Type;
...
#define I2CSMB_BASE           (PERIPH_BASE + 0x00012800UL)
#define UART2_BASE            (PERIPH_BASE + 0x00013000UL)
...
#define I2CSMB                ((I2CSMB_Type *) I2CSMB_BASE)
