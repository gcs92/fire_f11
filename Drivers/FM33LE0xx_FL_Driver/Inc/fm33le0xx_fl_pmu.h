...
#ifndef __FM33LE0XX_FL_PMU_H
#define __FM33LE0XX_FL_PMU_H
...
#define    PMU_WKFR_I2CSMBWKF_Pos                                 (25U)
#define    PMU_WKFR_I2CSMBWKF_Msk                                 (0x1U << PMU_WKFR_I2CSMBWKF_Pos)
#define    PMU_WKFR_PMU_WKFR_I2CSMBWKF_Msk                         PMU_WKFR_I2CSMBWKF_Msk
...
#define    PMU_WKFR_LINWKF_Pos                                    (22U)
#define    PMU_WKFR_LINWKF_Msk                                    (0x1U << PMU_WKFR_LINWKF_Pos)
#define    PMU_WKFR_LINWKF                                         PMU_WKFR_LINWKF_Msk
...
/**
  * @brief    Get I2CSMB interrupt wakeup flag
  * @rmtoll   WKFR    I2CSMBWKF    FL_PMU_IsActiveFlag_WakeupI2CSMB
  * @param    PMUx PMU instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_PMU_IsActiveFlag_WakeupI2CSMB(PMU_Type *PMUx)
{
    return (uint32_t)(READ_BIT(PMUx->WKFR, PMU_WKFR_I2CSMBWKF_Msk) == (PMU_WKFR_I2CSMBWKF_Msk));
}
...
/**
  * @brief    Get LIN interrupt wakeup flag
  * @rmtoll   WKFR    LINWKF    FL_PMU_IsActiveFlag_WakeupLIN
  * @param    PMUx PMU instance
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_PMU_IsActiveFlag_WakeupLIN(PMU_Type *PMUx)
{
    return (uint32_t)(READ_BIT(PMUx->WKFR, PMU_WKFR_LINWKF_Msk) == (PMU_WKFR_LINWKF_Msk));
}
