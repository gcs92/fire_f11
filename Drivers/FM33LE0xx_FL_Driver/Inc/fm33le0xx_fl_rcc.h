...
#ifndef __FM33LE0XX_FL_RCC_H
#define __FM33LE0XX_FL_RCC_H
...
#define    FDET_ISR_HFRDY_Pos                                     (3U)
#define    FDET_ISR_HFRDY_Msk                                     (0x1U << FDET_ISR_HFRDY_Pos)
#define    FDET_ISR_HFRDY                                         FDET_ISR_HFRDY_Msk

#define    FDET_ISR_LFRDY_Pos                                     (2U)
#define    FDET_ISR_LFRDY_Msk                                     (0x1U << FDET_ISR_LFRDY_Pos)
#define    FDET_ISR_LFRDY                                         FDET_ISR_LFRDY_Msk
...
#define    RCC_LPOSCCR_LPOENB_Pos                                 (0U)
...
#define    RCC_XTLFCR_WAIT_Pos                                    (16U)
#define    RCC_XTLFCR_WAIT_Msk                                    (0x7U << RCC_XTLFCR_WAIT_Pos)
#define    RCC_XTLFCR_WAIT                                        RCC_XTLFCR_WAIT_Msk
...
#define    RCC_XTHFCR_WAIT_Pos                                    (16U)
#define    RCC_XTHFCR_WAIT_Msk                                    (0x7U << RCC_XTHFCR_WAIT_Pos)
#define    RCC_XTHFCR_WAIT                                        RCC_XTHFCR_WAIT_Msk
...
#define    RCC_OPCCR1_I2CSMBCKS_Pos                               (18U)
#define    RCC_OPCCR1_I2CSMBCKS_Msk                               (0x3U << RCC_OPCCR1_I2CSMBCKS_Pos)
#define    RCC_OPCCR1_I2CSMBCKS                                   RCC_OPCCR1_I2CSMBCKS_Msk
...
#define    RCC_OPCCR1_UART2CKS_Pos                                (2U)
#define    RCC_OPCCR1_UART2CKS_Msk                                (0x3U << RCC_OPCCR1_UART2CKS_Pos)
#define    RCC_OPCCR1_UART2CKS                                    RCC_OPCCR1_UART2CKS_Msk
...
#define    FL_RCC_GROUP3_BUSCLK_UART2                             (0x1U << 10U)
...
#define    FL_RCC_GROUP3_BUSCLK_I2CSMB                            (0x1U << 25U)
...
#define    FL_RCC_GROUP1_OPCLK_I2CSMB                             (0x1U << 21U)
#define    FL_RCC_GROUP1_OPCLK_I2C                                (0x1U << 20U)
#define    FL_RCC_GROUP1_OPCLK_ATIM                               (0x1U << 15U)
#define    FL_RCC_GROUP1_OPCLK_LIN                                (0x1U << 11U)
#define    FL_RCC_GROUP1_OPCLK_UART2                              (0x1U << 10U)
...
#define    FL_RCC_RSTAPB_UART2                                    (0x1U << 28U)
...
#define    FL_RCC_RSTAPB_I2CSMB                                   (0x1U << 4U)
...
#define    FL_RCC_XTLF_START_WAIT_CYCLE_128                       (0x0U << RCC_XTLFCR_WAIT_Pos)
#define    FL_RCC_XTLF_START_WAIT_CYCLE_256                       (0x1U << RCC_XTLFCR_WAIT_Pos)
#define    FL_RCC_XTLF_START_WAIT_CYCLE_512                       (0x2U << RCC_XTLFCR_WAIT_Pos)
#define    FL_RCC_XTLF_START_WAIT_CYCLE_1024                      (0x3U << RCC_XTLFCR_WAIT_Pos)
#define    FL_RCC_XTLF_START_WAIT_CYCLE_2048                      (0x4U << RCC_XTLFCR_WAIT_Pos)
#define    FL_RCC_XTLF_START_WAIT_CYCLE_4096                      (0x5U << RCC_XTLFCR_WAIT_Pos)
#define    FL_RCC_XTLF_START_WAIT_CYCLE_8192                      (0x6U << RCC_XTLFCR_WAIT_Pos)
#define    FL_RCC_XTLF_START_WAIT_CYCLE_16384                     (0x7U << RCC_XTLFCR_WAIT_Pos)
...
#define    FL_RCC_XTHF_START_WAIT_CYCLE_128                       (0x0U << RCC_XTHFCR_WAIT_Pos)
#define    FL_RCC_XTHF_START_WAIT_CYCLE_256                       (0x1U << RCC_XTHFCR_WAIT_Pos)
#define    FL_RCC_XTHF_START_WAIT_CYCLE_512                       (0x2U << RCC_XTHFCR_WAIT_Pos)
#define    FL_RCC_XTHF_START_WAIT_CYCLE_1024                      (0x3U << RCC_XTHFCR_WAIT_Pos)
#define    FL_RCC_XTHF_START_WAIT_CYCLE_2048                      (0x4U << RCC_XTHFCR_WAIT_Pos)
#define    FL_RCC_XTHF_START_WAIT_CYCLE_4096                      (0x5U << RCC_XTHFCR_WAIT_Pos)
#define    FL_RCC_XTHF_START_WAIT_CYCLE_8192                      (0x6U << RCC_XTHFCR_WAIT_Pos)
#define    FL_RCC_XTHF_START_WAIT_CYCLE_16384                     (0x7U << RCC_XTHFCR_WAIT_Pos)
...
#define    FL_RCC_I2CSMB_CLK_SOURCE_APB1CLK                       (0x0U << RCC_OPCCR1_I2CSMBCKS_Pos)
#define    FL_RCC_I2CSMB_CLK_SOURCE_RCHF                          (0x1U << RCC_OPCCR1_I2CSMBCKS_Pos)
#define    FL_RCC_I2CSMB_CLK_SOURCE_SYSCLK                        (0x2U << RCC_OPCCR1_I2CSMBCKS_Pos)
#define    FL_RCC_I2CSMB_CLK_SOURCE_RCMF_PSC                      (0x3U << RCC_OPCCR1_I2CSMBCKS_Pos)
...
#define    FL_RCC_UART2_CLK_SOURCE_APB1CLK                        (0x0U << RCC_OPCCR1_UART2CKS_Pos)
#define    FL_RCC_UART2_CLK_SOURCE_RCHF                           (0x1U << RCC_OPCCR1_UART2CKS_Pos)
#define    FL_RCC_UART2_CLK_SOURCE_SYSCLK                         (0x2U << RCC_OPCCR1_UART2CKS_Pos)
#define    FL_RCC_UART2_CLK_SOURCE_RCMF_PSC                       (0x3U << RCC_OPCCR1_UART2CKS_Pos)
...
/**
  * @brief    Enable LPOSC
  * @rmtoll   LPOSC    LPOENB    FL_RCC_LPOSC_Enable
  * @retval   None
  */
__STATIC_INLINE void FL_RCC_LPOSC_Enable(void)
{
    CLEAR_BIT(RCC->LPOSCCR, RCC_LPOSCCR_LPOENB_Msk);
}

/**
  * @brief    Disable LPOSC
  * @rmtoll   LPOSC   LPOENB    FL_RCC_LPOSC_Disable
  * @retval   None
  */
__STATIC_INLINE void FL_RCC_LPOSC_Disable(void)
{
    SET_BIT(RCC->LPOSCCR, RCC_LPOSCCR_LPOENB_Msk);
}
...
/**
  ...
  * @rmtoll   XTLFCR    WAIT    FL_RCC_XTLF_SetStartWaitTime
  * @param    clock This parameter can be one of the following values:
  *           @arg @ref FL_RCC_XTLF_START_WAIT_CYCLE_128
  *           @arg @ref FL_RCC_XTLF_START_WAIT_CYCLE_256
  *           @arg @ref FL_RCC_XTLF_START_WAIT_CYCLE_512
  *           @arg @ref FL_RCC_XTLF_START_WAIT_CYCLE_1024
  *           @arg @ref FL_RCC_XTLF_START_WAIT_CYCLE_2048
  *           @arg @ref FL_RCC_XTLF_START_WAIT_CYCLE_4096
  *           @arg @ref FL_RCC_XTLF_START_WAIT_CYCLE_8192
  *           @arg @ref FL_RCC_XTLF_START_WAIT_CYCLE_16384
  * @retval   None
  */
__STATIC_INLINE void FL_RCC_XTLF_SetStartWaitTime(uint32_t clock)
{
    MODIFY_REG(RCC->XTLFCR, RCC_XTLFCR_WAIT_Msk, clock);
}

/**
  * @brief    Get XTLF Start Wait Time
  * @rmtoll   XTLFCR    WAIT    FL_RCC_XTLF_GetStartWaitTime
  * @retval   Returned value can be one of the following values:
  *           @arg @ref FL_RCC_XTLF_START_WAIT_CYCLE_128
  *           @arg @ref FL_RCC_XTLF_START_WAIT_CYCLE_256
  *           @arg @ref FL_RCC_XTLF_START_WAIT_CYCLE_512
  ...
  *           @arg @ref FL_RCC_XTLF_START_WAIT_CYCLE_16384
  */
__STATIC_INLINE uint32_t FL_RCC_XTLF_GetStartWaitTime(void)
{
    return (uint32_t)(READ_BIT(RCC->XTLFCR, RCC_XTLFCR_WAIT_Msk));
}
...
/**
  ...
  * @rmtoll   XTLFCR    RDY    FL_RCC_XTLF_IsReady
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_RCC_XTLF_IsReady(void)
{
    return (uint32_t)(READ_BIT(FDET->ISR, FDET_ISR_LFRDY_Msk) == FDET_ISR_LFRDY_Msk);
}
...
/**
  ...
  * @rmtoll   XTHFCR    WAIT    FL_RCC_XTHF_SetStartWaitTime
  * @param    clock This parameter can be one of the following values:
  *           @arg @ref FL_RCC_XTHF_START_WAIT_CYCLE_128
  *           @arg @ref FL_RCC_XTHF_START_WAIT_CYCLE_256
  *           @arg @ref FL_RCC_XTHF_START_WAIT_CYCLE_512
  *           @arg @ref FL_RCC_XTHF_START_WAIT_CYCLE_1024
  *           @arg @ref FL_RCC_XTHF_START_WAIT_CYCLE_2048
  *           @arg @ref FL_RCC_XTHF_START_WAIT_CYCLE_4096
  *           @arg @ref FL_RCC_XTHF_START_WAIT_CYCLE_8192
  *           @arg @ref FL_RCC_XTHF_START_WAIT_CYCLE_16384
  * @retval   None
  */
__STATIC_INLINE void FL_RCC_XTHF_SetStartWaitTime(uint32_t clock)
{
    MODIFY_REG(RCC->XTHFCR, RCC_XTHFCR_WAIT_Msk, clock);
}

/**
  * @brief    Get XTHF Start Wait Time
  * @rmtoll   XTHFCR    WAIT    FL_RCC_XTHF_GetStartWaitTime
  * @retval   Returned value can be one of the following values:
  *           @arg @ref FL_RCC_XTHF_START_WAIT_CYCLE_128
  *           @arg @ref FL_RCC_XTHF_START_WAIT_CYCLE_256
  *           @arg @ref FL_RCC_XTHF_START_WAIT_CYCLE_512
  ...
  *           @arg @ref FL_RCC_XTHF_START_WAIT_CYCLE_16384
  */
__STATIC_INLINE uint32_t FL_RCC_XTHF_GetStartWaitTime(void)
{
    return (uint32_t)(READ_BIT(RCC->XTHFCR, RCC_XTHFCR_WAIT_Msk));
}
...
/**
  ...
  * @rmtoll   XTHFCR    RDY    FL_RCC_XTHF_IsReady
  * @retval   State of bit (1 or 0).
  */
__STATIC_INLINE uint32_t FL_RCC_XTHF_IsReady(void)
{
    return (uint32_t)(READ_BIT(FDET->ISR, FDET_ISR_HFRDY_Msk) == FDET_ISR_HFRDY_Msk);
}
...
/**
  ...
  *           @arg @ref FL_RCC_GROUP3_BUSCLK_UART2
  ...
  *           @arg @ref FL_RCC_GROUP3_BUSCLK_I2CSMB
  * @retval   None
  */
...
/**
  ...
  *           @arg @ref FL_RCC_GROUP1_OPCLK_I2CSMB
  *           @arg @ref FL_RCC_GROUP1_OPCLK_I2C
  *           @arg @ref FL_RCC_GROUP1_OPCLK_ATIM
  *           @arg @ref FL_RCC_GROUP1_OPCLK_LIN
  *           @arg @ref FL_RCC_GROUP1_OPCLK_UART2
...
/**
  * @brief    Set I2CSMB Clock Source
  * @rmtoll   OPCCR1    I2CSMBCKS    FL_RCC_SetI2CSMBClockSource
  * @param    clock This parameter can be one of the following values:
  *           @arg @ref FL_RCC_I2CSMB_CLK_SOURCE_APB1CLK
  *           @arg @ref FL_RCC_I2CSMB_CLK_SOURCE_RCHF
  *           @arg @ref FL_RCC_I2CSMB_CLK_SOURCE_SYSCLK
  *           @arg @ref FL_RCC_I2CSMB_CLK_SOURCE_RCMF_PSC
  * @retval   None
  */
__STATIC_INLINE void FL_RCC_SetI2CSMBClockSource(uint32_t clock)
{
    MODIFY_REG(RCC->OPCCR1, RCC_OPCCR1_I2CSMBCKS_Msk, clock);
}

/**
  * @brief    Get I2CSMB Clock Source Setting
  * @rmtoll   OPCCR1    I2CSMBCKS    FL_RCC_GetI2CSMBClockSource
  * @retval   Returned value can be one of the following values:
  *           @arg @ref FL_RCC_I2CSMB_CLK_SOURCE_APB1CLK
  *           @arg @ref FL_RCC_I2CSMB_CLK_SOURCE_RCHF
  *           @arg @ref FL_RCC_I2CSMB_CLK_SOURCE_SYSCLK
  *           @arg @ref FL_RCC_I2CSMB_CLK_SOURCE_RCMF_PSC
  */
__STATIC_INLINE uint32_t FL_RCC_GetI2CSMBClockSource(void)
{
    return (uint32_t)(READ_BIT(RCC->OPCCR1, RCC_OPCCR1_I2CSMBCKS_Msk));
}
...
/**
  ...
  * @rmtoll   OPCCR1    UART1CKS    FL_RCC_SetUART2ClockSource
  * @param    clock This parameter can be one of the following values:
  *           @arg @ref FL_RCC_UART2_CLK_SOURCE_APB1CLK
  *           @arg @ref FL_RCC_UART2_CLK_SOURCE_RCHF
  *           @arg @ref FL_RCC_UART2_CLK_SOURCE_SYSCLK
  *           @arg @ref FL_RCC_UART2_CLK_SOURCE_RCMF_PSC
  * @retval   None
  */
__STATIC_INLINE void FL_RCC_SetUART2ClockSource(uint32_t clock)
{
    MODIFY_REG(RCC->OPCCR1, RCC_OPCCR1_UART2CKS_Msk, clock);
}

/**
  * @brief    Get UART2 Clock Source Setting
  * @rmtoll   OPCCR1    UART1CKS    FL_RCC_GetUART2ClockSource
  * @retval   Returned value can be one of the following values:
  *           @arg @ref FL_RCC_UART2_CLK_SOURCE_APB1CLK
  *           @arg @ref FL_RCC_UART2_CLK_SOURCE_RCHF
  *           @arg @ref FL_RCC_UART2_CLK_SOURCE_SYSCLK
  *           @arg @ref FL_RCC_UART2_CLK_SOURCE_RCMF_PSC
  */
__STATIC_INLINE uint32_t FL_RCC_GetUART2ClockSource(void)
{
    return (uint32_t)(READ_BIT(RCC->OPCCR1, RCC_OPCCR1_UART2CKS_Msk));
}
