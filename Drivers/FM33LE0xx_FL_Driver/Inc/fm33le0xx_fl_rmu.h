...
#ifndef __FM33LE0XX_FL_RMU_H
#define __FM33LE0XX_FL_RMU_H
...
/**
  ...
  *           @arg @ref FL_RMU_PDR_THRESHOLD_1P3V
...
/**
  ...
  * @rmtoll   BORCR    ENB    FL_RMU_BORPowerDown_IsEnabled
  * @param    RMUx RMU instance
  * @retval   State of bit (1 or 0).
  */
...
/**
  ...
  * @rmtoll   BORCR    ENB    FL_RMU_BORPowerDown_Disable
  * @param    RMUx RMU instance
  * @retval   None
  */
...
/**
  ...
  * @rmtoll   BORCR    ENB    FL_RMU_BORPowerDown_Enable
  * @param    RMUx RMU instance
  * @retval   None
  */
