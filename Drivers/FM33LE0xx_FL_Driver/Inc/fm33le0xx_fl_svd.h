...
#ifndef __FM33LE0XX_FL_SVD_H
#define __FM33LE0XX_FL_SVD_H
...
#define    SVD_CR_SVSCFG_Pos                                      (9U)
#define    SVD_CR_SVSCFG_Msk                                      (0x1U << SVD_CR_SVSCFG_Pos)
#define    SVD_CR_SVSCFG                                          SVD_CR_SVSCFG_Msk
...
/**
  * @brief    Enable SVD LC0 bug-fix in SVS mode
  * @rmtoll   CR   SVSCFG    FL_SVD_EnableSVSBugFix
  * @param    SVDx SVD instance
  * @retval   None
  */
__STATIC_INLINE void FL_SVD_EnableSVSBugFix(SVD_Type *SVDx)
{
    SET_BIT(SVDx->CR, SVD_CR_SVSCFG_Msk);
}

/**
  * @brief    Disable SVD LC0 bug-fix in SVS mode
  * @rmtoll   CR    SVSCFG    FL_SVD_DisableSVSBugFix
  * @param    SVDx SVD instance
  * @retval   None
  */
__STATIC_INLINE void FL_SVD_DisableSVSBugFix(SVD_Type *SVDx)
{
    CLEAR_BIT(SVDx->CR, SVD_CR_SVSCFG_Msk);
}
