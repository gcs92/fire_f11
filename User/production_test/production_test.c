...
static F12_PROTOCOL test_send_data = {0xf0,0x00,0x55};
...
void production_test_flag_close(void)
{
	...
	test_send_data.data = 0x00;
	UART_Tx(5,&test_send_data,sizeof(F12_PROTOCOL));
}
